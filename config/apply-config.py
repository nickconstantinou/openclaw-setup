...
def main():
    ...
    _fallbacks = (
        ['minimax/MiniMax-M2.1', 'nvidia/moonshotai/kimi-k2-instruct', 'nvidia/qwen/qwen3-235b-a22b']
    ...
    if _nvidia_active:
        _coding_primary   = 'nvidia/moonshotai/kimi-k2-instruct'
        _coding_fallback  = ['minimax/MiniMax-M2.5', 'minimax/MiniMax-M2.1', 'nvidia/qwen/qwen3-235b-a22b']
        _frontend_primary  = 'nvidia/moonshotai/kimi-k2-instruct'
        _frontend_fallback = ['minimax/MiniMax-M2.5', 'minimax/MiniMax-M2.1', 'nvidia/qwen/qwen3-235b-a22b']
    else:
